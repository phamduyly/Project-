...
Public Class Customer
    ...
    Private Sub btnBookingFrm_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnBookingFrm.Click
        Try
    ...
    Private Function CusValid() As Boolean
        ...
        bIsValid = oValidation.isAlphaNumericVal(txtCusFirName.Text)
        If bIsValid Then
        ...
        bIsValid = oValidation.isAlphaNumericVal(txtCusLasName.Text)
        If bIsValid Then
