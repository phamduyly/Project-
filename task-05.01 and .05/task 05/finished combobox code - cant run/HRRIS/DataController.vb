...
Public Class DataController
    ...
    Public Sub CusInsert(ByRef CusData As Hashtable)
        ...
        Try
            ...
            oCommand.Parameters.Add("phone", OleDbType.Integer, 12)
            ...
            oCommand.Parameters("phone").Value = CInt(CusData("phone"))
    ...
    Public function findALl() as list(Of Hashtable) 
        ...
        Try
            ...
            oCommand.CommandText = "SELECT * FROM room ORDER BY SKU;"
